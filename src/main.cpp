...
//block.nNonce = 2347291
        ...
        const char* pszTimestamp = "Fire tornado in B.C. Canada. really? lmao";
        CTransaction txNew;
        txNew.nTime = 1537995150;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1537995150;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = !fTestNet ? 435209 : 435209;
	...
	fflush(NULL);
        ...
        assert(block.hashMerkleRoot == uint256("0x7822214c067162c1199569a3ff31e157945d3501dd0ddb6a04223d7540bfcc82"));
